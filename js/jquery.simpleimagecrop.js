 ...
 (function($) {
	...
	$.fn.extend({ 
            ...
            return this.each(function() {
				...
				var initialCropBoxWidth = 100;
				var initialCropBoxHeight = 100 / cropAspectRatio;
					...
					$.ajax({
						...
						success: function() {
							...
							$('#crop_message').css("visibility", "visible");
												$.ajax({
						url: o.phpScriptLocation,
						data: {x: 0, y: 0, w: 128, h: 128, dimension_x: 40, dimension_y: 40, image_path: imagePath, image_destination: o.imageDestination2}, 
						type: 'post',
						success: function() {
